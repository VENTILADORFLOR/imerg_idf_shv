"""
01_data_extraction/imerg_2020_2024.py

Extract GPM IMERG V07 half-hourly precipitation for the Sihanoukville study point,
period 2020-01-01 to 2025-01-01 (i.e. complete years 2020-2024), and export to Google Drive as CSV.
...
task = ee.batch.Export.table.toDrive(
    collection=features,
    description="Rainfall_Point_IMERG_2020_2024",
    folder="GEE_Exports",
    fileNamePrefix="rainfall_point_imerg_2020_2024",
    fileFormat="CSV",
)
